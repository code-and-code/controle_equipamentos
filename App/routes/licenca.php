...
$ar["{$prefix}.serial.addcomputador"]    = ['route' => "/{$prefix}/serial/add-computador",   'controller' => 'SerialController', 'method'=>'POST','auth' =>$auth, 'action' => 'addComputador'     ];
$ar["{$prefix}.serial.removecomputador"] = ['route' => "/{$prefix}/serial/remove-computador",'controller' => 'SerialController', 'method'=>'GET', 'auth' =>$auth, 'action' => 'removeComputador'  ];